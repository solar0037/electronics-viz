...
def main():
    ...
    kvl_kcl_page = st.Page("circuits/kvl_kcl.py", title="KVL/KCL")
    ...
    pg = st.navigation([home_page, kvl_kcl_page, rc_lpf_page, rl_hpf_page, op_amp_page, diode_page, mosfet_page, common_source_amp_page])
    pg.run()
